...
{
e.preventDefault();
textStatus.innerHTML = "The fields cannot be empt";
...
{
e.preventDefault();
textStatus.innerHTML = "The reservation numbe field cannot be empt";
}
else if(!reservation_date)
{
e.preventDefault();
textStatus.innerHTML = "The reservation date field cannot be empt";
}
else if(!reservation_time)
{
    e.preventDefault();
    textStatus.innerHTML = "The reservation time field cannot be empt";
